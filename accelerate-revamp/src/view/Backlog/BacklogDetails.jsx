...
import useAddBacklogServices from '../../viewModel/backlogViewModel/addBacklogServices'
import CustomDrawer from '../../components/CustomDrawer'
import AddBacklog from './AddBacklog'

const BacklogDetails = (props) => {
    const { backlogs } = props

    const totalResults = backlogs?.Total_result

    const {tabToggleState, currentState} = useTabToggle()
    const { addBackLogValue, handleAddBacklog, handleChangeAddBackLog, handleSelectAddBackLog} = useAddBacklogServices()
  return (
    <>
        <div className='space-y-6'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex flex-row gap-3'>
                    ...
                    <button className='px-2 py-1 cursor-pointer text-customBlue-100 bg-customBlue-600 rounded-lg border border-customBlue-100 text-[12px]'
            ...
            <div className='grid grid-cols-4 gap-4'>
                <div className='flex w-[270px] h-[120px] border border-customBlue-100 rounded-lg bg-customBlue-600 gap-2'>
                    ...
                    <div className='flex-1 flex items-center '>
                        <div className='flex flex-col items-center '>
                            <span className='text-center text-[20px] font-semibold'>{totalResults?.total_backlogs}</span>
                ...
                <div className='flex w-[270px] h-[120px] border border-customYellow-100 rounded-lg bg-customYellow-200 gap-2'>
                    ...
                    <div className='flex-1 flex items-center '>
                        <div className='flex flex-col items-center '>
                            <span className='text-center text-[20px] font-semibold'>{totalResults?.pending_backlogs}</span>
                ...
                <div className='flex w-[270px] h-[120px] border border-customPurple-100 rounded-lg bg-customPurple-200 gap-2'>
                    ...
                    <div className='flex-1 flex items-center '>
                        <div className='flex flex-col items-center '>
                            <span className='text-center text-[20px] font-semibold'>{totalResults?.progress_backlogs}</span>
                ...
                <div className='flex w-[270px] h-[120px] border border-customGreen-400 rounded-lg bg-customGreen-300 gap-2'>
                    ...
                    <div className='flex-1 flex items-center '>
                        <div className='flex flex-col items-center '>
                            <span className='text-center text-[20px] font-semibold'>{totalResults?.completed_backlogs}</span>
                            <span className='text-center'>Complete Tasks</span>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        {addBackLogValue.show && 
            <CustomDrawer 
                open={addBackLogValue.show}
                closeDrawer={handleAddBacklog}
                compo={
                    <AddBacklog 
                        addBackLogValue= {addBackLogValue}
                        handleChangeAddBackLog= {handleChangeAddBackLog}
                        handleSelectAddBackLog= {handleSelectAddBackLog}
                    />
                }
